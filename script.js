...
const ARTICLES_DATA = [
  {
    ...
    <p>Kegiatan Ramadhan ini diisi dengan berbagai agenda seperti tadarus Al-Qur’an, tausiyah, doa bersama, serta kegiatan menghias kelas. Setiap siswa berperan aktif dalam menyukseskan acara, mulai dari mempersiapkan perlengkapan hingga mengikuti setiap rangkaian kegiatan dengan tertib dan khidmat.</p>
    ...
    <p>Salah satu momen yang paling berkesan adalah saat kegiatan menghias kelas. Dengan penuh semangat, para siswa bergotong royong dalam menghias kelas sebagai bentuk kepedulian dan rasa syukur di bulan Ramadhan.</p>
